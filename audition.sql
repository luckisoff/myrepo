...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2019 at 10:22 AM
...
(1, 'Admin', 'admin@infinity.com', '$2y$10$LFUsKL7gFZf2Gxx89ehRWOnSAwqJ/HRvGtmKYaaFPSaeeQWlI0RS2', 'https://bharyang.com.np/infinity/uploads/0302d161dbc04be7aae350bd81c440b908cef049.png', '', 1, 'male', '9851234196', '', 'Baneshwor', '2y103sf5iFjEfS22yRMQxBLwuuce087N0OmkqFfkCPKY7OFAPyq3gEp2', '1568871873', 'pLXzVMXJWb0TkdOc05N30bg9jHguzPlmJvssOAzhh47qDsm2nxWndt2Lz4jh', 'Asia/Kathmandu', '2017-08-05 04:02:43', '2019-08-19 23:59:33'),
(2, 'Test', 'test@streamhash.com', '$2y$10$h.3BkdXzIqehzpWEtGrTNuur5D1IbrxPhlXjfy8XRe9klI5ZUExQe', 'http://adminview.streamhash.com/placeholder.png', '', 0, 'male', '', '', '', '', '', '1O9RYoWanuUnkglBnEuftH31bDs13hGmLDRegkVw9uOXQjwpH6I5Nn18TXl4', 'Asia/Kathmandu', '2017-08-05 04:02:43', '2019-08-08 04:16:40');
...
--
-- Table structure for table `audition_banners`
--

CREATE TABLE `audition_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `audition_location`
--

CREATE TABLE `audition_location` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `audition_registration`
--

CREATE TABLE `audition_registration` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `communication_address` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `issue_place` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `audition_sponser`
--

CREATE TABLE `audition_sponser` (
  `id` int(11) NOT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `partner_type` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `categories` (`id`, `name`, `picture`, `is_series`, `status`, `is_approved`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'Saregama', 'https://bharyang.com.np/infinity/uploads/2cfba0b3352ba18dfa0bcf0e605226c7201aa5eb.png', 0, '1', 1, 0, '2019-08-01 01:42:57', '2019-08-01 01:42:57'),
(2, 'team leader', 'http://localhost/bharyang/infinity/uploads/0dea6436f8abecb2fa39bb8044501289cf4f39dc.jpeg', 1, '1', 1, 0, '2019-08-04 00:54:49', '2019-08-04 00:54:49');
...
CREATE TABLE `judges` (
  ...
  `insta_link` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `pages` (`id`, `heading`, `description`, `type`, `created_at`, `updated_at`) VALUES
(1, 'Audition', 'For audition of Tiktok Star.', '', '2019-07-25 04:08:42', '2019-07-25 04:08:42');
...
(1, 'site_name', 'test', NULL, '2019-08-04 00:47:10'),
(2, 'site_logo', 'http://localhost/bharyang/infinity/uploads/46594090a6b601f50ba854ee88d473aebb239327.jpeg', NULL, '2019-08-04 00:47:10'),
(3, 'site_icon', 'http://localhost/bharyang/infinity/uploads/2a0248e23b203f4ac216e286e913d1ad3b637b76.jpg', NULL, '2019-08-04 00:47:10'),
...
(11, 'installation_process', '3', NULL, '2019-08-04 00:47:10'),
...
(1, 'User', 'test@gmail.com', '$2y$10$7flX20oQoh/SRp6rnlD9PeFJTL/QoYSz2yb4FfsfDHveVFpC9Z83C', 'http://lite.streamhash.com/placeholder.png', '2y106b0pPxgvUJGiQKRMohHMWspa5EpwWEFRvLlk0hC556pHpJ6Bny', '1566644232', '', 'android', 'manual', '', '', '', '', 1, 1, 0, 1, 0, 0, 'male', '9843419254', 0.00000000, 0.00000000, '', '', NULL, '2017-08-05 04:02:43', '2019-07-25 02:57:12'),
...
--
-- Indexes for table `audition_banners`
--
ALTER TABLE `audition_banners`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `audition_location`
--
ALTER TABLE `audition_location`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `audition_registration`
--
ALTER TABLE `audition_registration`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `audition_sponser`
--
ALTER TABLE `audition_sponser`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `audition_banners`
--
ALTER TABLE `audition_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `audition_location`
--
ALTER TABLE `audition_location`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `audition_registration`
--
ALTER TABLE `audition_registration`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `audition_sponser`
--
ALTER TABLE `audition_sponser`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
