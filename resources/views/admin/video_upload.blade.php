                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="other_image1" name="other_image1" accept="image/jpeg,image/png" placeholder="{{tr('other_image1')}}">
                            </div>

                            <div class="form-group">
                                <label for="other_image2" class="">{{tr('other_image2')}}</label>
                                <input type="file" class="form-control" id="other_image2" name="other_image2" accept="image/jpeg,image/png" placeholder="{{tr('other_image2')}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="duration" class="form-control" data-inputmask="'alias': 'hh:mm:ss'" data-mask>
                                </div>
                                <!-- /.input group -->
                            </div>
