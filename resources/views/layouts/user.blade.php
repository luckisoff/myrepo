...
<html lang="en">
    <head>
       ...
       <?php echo Setting::get('header_scripts'); ?>
        ...
        <meta property="og:title" content="{{Setting::get('site_name' , 'Start Hash')}}" />
        <meta property="og:description" content="The best solution to start up a video streaming venture!" />
        <meta property="og:url" content="" />
        <meta property="og:site_name" content="{{Setting::get('site_name' , 'Start Hash')}}" />
        ...
        <meta name="twitter:title" content="{{Setting::get('site_name' , 'Start Hash')}}"/>
